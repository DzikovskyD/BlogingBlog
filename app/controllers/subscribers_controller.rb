class SubscribersController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @subscriber.save
        format.html { redirect_to @subscriber, notice: "Подписчик создан!" }
  ...
  def update
    respond_to do |format|
      if @subscriber.update(subscriber_params)
        format.html { redirect_to @subscriber, notice: "Подписчик обновлён!" }
  ...
  def destroy
    @subscriber.destroy
    respond_to do |format|
      format.html { redirect_to subscribers_url, notice: "Подписчик удалён!" }
